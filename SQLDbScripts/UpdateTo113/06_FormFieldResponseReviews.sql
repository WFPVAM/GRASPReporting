...
/****** Object:  View [dbo].[FormFieldResponsesReviews]    Script Date: 11/21/2014 16:54:11 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[FormFieldResponsesReviews]'))
DROP VIEW [dbo].[FormFieldResponsesReviews]
GO
