...
/****** Object:  View [dbo].[SurveyListAPI]    Script Date: 11/14/2014 19:01:57 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[SurveyListAPI]'))
DROP VIEW [dbo].[SurveyListAPI]
GO
