        ...
        <script type="text/javascript">
            function Export() {
                ...
                if (separator != null) {
                    ...
                    if (type == "CSV") {
                        window.location = "<%="CSVExport.aspx?FormID=" + formID + "&FormName=" + name%>" + "&separator=" + separator + "&linear=" + table;
        ...
        <div class="row" style="margin: 0; border: 1px solid #0058b1; padding: 20px 20px 20px 0; margin: 0 15px;">
            <div class="col-lg-6 col-sm-6">
                ...
                <div class="col-lg-3 form-group">
                    ...
                    <label class="radio">
                        <input type="radio" name="type" id="SPSS" value="SPSS" />SPSS
                    </label>
                </div>
                <div class="col-lg-3 form-group">
                    <input type="checkbox" name="linear"> Tables on a single record </input>
                    ...
                    <telerik:RadToolTip ID="RadToolTip4" runat="server" RelativeTo="Element" Width="200px" AutoCloseDelay="10000" Skin="MetroTouch"
                        Text="Each table and roster is exported as a separate file containing an ID that can be used to join it to the main form in a relational database design. Select this option if you prefer table records to be exported inside the main data of the fom in a single record." TargetControlID="linear" IsClientID="true"
                        Position="BottomRight">
                    </telerik:RadToolTip>
                </div>
                <telerik:RadButton ID="RadButton1" runat="server" AutoPostBack="false" BackColor="White" Text="Export" Skin="MetroTouch" OnClientClicked="Export"></telerik:RadButton>
            </div>
            <div class="col-lg-6 col-sm-6">
