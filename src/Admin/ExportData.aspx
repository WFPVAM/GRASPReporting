...
<head runat="server">
    ...
    <style type="text/css">
        ...
        label { display: inline-block; margin-bottom: 5px; font-weight: bold; width: 160px; }
        #error { display: none; }
...
<div class="row" style="margin:0;font-size:11px;">
            <div class="col-lg-12">
        ...
        <div class="row" style="margin: 0; border: 1px solid #0058b1; padding: 20px 20px 20px 0; margin: 0 15px;">
            <div class="col-lg-6 col-sm-6">
                ...
                <div class="col-lg-6 form-group">
                    ...
                    <asp:TextBox ID="txtStartFromResponseID" runat="server" Text="0" ToolTip="Only the first 10000 responses starting from this ID will be exported."></asp:TextBox>
                    </div>
                    <div class="controls-group">
                    <label>Separator:</label>
                    <telerik:RadComboBox ID="ddlCharacter" OnClientSelectedIndexChanged="RemoveErrorPanel" runat="server" EmptyMessage="Select a separator" EnableLoadOnDemand="True" Skin="Metro" BorderColor="#66AFE9" BackColor="White">
                        <Items>
