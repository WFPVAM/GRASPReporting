<%@ Page Title="" Language="C#" MasterPageFile="~/_master/AngularJS.master" AutoEventWireup="true" CodeFile="DataEditWebForm.aspx.cs" Inherits="DataEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <style type="text/css">
        ...
        #pnlWait {display:none;width:100%;height:100%;position:absolute;top:0;left:0;opacity:0.5; }
            #pnlWait h1 { font-size: 24px; opacity: 1; width: 100%; text-align: center;margin:auto 0; }
    </style>
    <%--    <script src="../_js/number-polyfill.js"></script>--%>
        <script>
            ...
            $.ajax({
                type: "POST",
                url: "DataEditWebForm.aspx/SaveFormAsJSON",
                //data: "{'result' : '" + res + "', 'formID' : '" + <%=formID%> + "'}",
                data:JSON.stringify({result:res,formID:<%=formID%>,formResponseID:<%=formResponseID%>}),
                ...
                success: function (msg) {
                    if (msg.d == 'undefined' || msg.d != '<%=formID%>') {
                        ...
                        window.location = 'DataEditWebForm.aspx?save=true&formID=' + msg.d + '&rid=<%=formResponseID%>';
                    }
                },
