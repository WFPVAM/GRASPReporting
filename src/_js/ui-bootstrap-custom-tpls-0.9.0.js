  ...
  return {
    ...
    link: function(scope, element, attrs, ctrls) {
      ...
      scope.select = function( date ) {
        if ( mode === 0 ) {
		ngModel.$setViewValue("1976-01-01");
          var dt = ngModel.$modelValue ? new Date( ngModel.$modelValue ) : new Date();
		  alert("c7");
          //dt.setTime(dt.setFullYear( date.getFullYear(), date.getMonth(), date.getDate(),0,0,0));
