...
public partial class FormField
{
    public FormField()
    {
        ...
        this.FormField1 = new HashSet<FormField>();
        this.FormField2 = new HashSet<FormField>();
        this.FormResponse = new HashSet<FormResponse>();
    }
    ...
    public virtual ICollection<FormField> FormField1 { get; set; }
    public virtual ICollection<FormField> FormField2 { get; set; }
    public virtual ICollection<FormResponse> FormResponse { get; set; }
}
...
public partial class FormResponseCoord
{
    ...
    public System.Data.Spatial.DbGeography FRCoordGeo { get; set; }
    public string frXCoordText { get; set; }
    public System.Data.Spatial.DbGeometry FRCoordGeometry { get; set; }
}
...
public partial class SmsInternetServiceSetting
{
    public SmsInternetServiceSetting()
    {
...
public partial class SmsInternetServiceSettings_SmsInternetServiceSettingValue
{
    ...
    public virtual SmsInternetServiceSetting SmsInternetServiceSetting { get; set; }
...
public partial class SmsModemSetting
{
    public decimal id { get; set; }
